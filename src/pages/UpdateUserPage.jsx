  ...
  return (
    ...
    <div className="flex flex-col items-center">
      <label className="cursor-pointer">
        <div className="h-32 w-32 rounded-full border-4 border-blue-200 flex items-center justify-center bg-gray-50 hover:bg-gray-100 transition overflow-hidden">
          {preview ? (
            <img
              src={preview}
              alt="Profile Preview"
            ...
            <MdOutlineCameraAlt className="h-8 w-8 text-gray-500" />
          )}
        </div>
      ...
      <p className="text-sm text-gray-500 mt-2">
        {preview ? "Change photo" : "Tap to add a photo"}
      </p>
    </div>
